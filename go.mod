...
require (
	...
	github.com/GoogleCloudPlatform/protoc-gen-bq-schema v0.0.0-20220624154704-34288dc182e3 // indirect
...
replace github.com/salrashid123/grpc_wireformat/grpc_services/src/echo => ./echo
